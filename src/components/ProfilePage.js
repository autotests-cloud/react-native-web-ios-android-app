...
export const LoginPage = () => {
    ...
    const compareWithFirstPassword = (newPassword) => {
        return newPassword !== password ? 'Two passwords that you enter is inconsistent!' : undefined
    }
    
    const validatePassword = (password) => {
        const validationRulesErrors = passwordSchema.validate(password, { list: true })
        return errors[validationRulesErrors[0]]
    }
